...
class Disposal extends DiaryActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, document_id, officer_id, disposal_date, disposal_type, disposal_ref_number, reference_dated, dispatcher_user_id, out_date, ref_file_page, file_id, is_reminder, owner_id, disposal, create_time, create_user, update_time, update_user', 'safe', 'on'=>'search'),
		);
	}
