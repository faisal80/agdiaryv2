...
class Marked extends DiaryActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
				...
				'assignment'=>array(self::HAS_ONE, 'OfficerDesigDutyAssignment', 'marked_to', 'condition'=>'state=1'),
				...
				'received_by_user'=>array(self::BELONGS_TO, 'Users', 'received_by'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'received_time_stamp' => 'Received Time Stamp',
