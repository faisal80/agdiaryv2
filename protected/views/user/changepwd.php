...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo '<label for="passwd" class="required">Enter your current password<span class="required">*</span></label>'; ?>
		<?php echo $form->passwordField($model,'passwd',array('size'=>60,'maxlength'=>255, 'value'=>'')); ?>
		<?php echo $form->error($model,'passwd'); ?>
	</div>

	<div class="row">
		<?php echo '<label for="newpasswd" class="required">Enter new password<span class="required">*</span></label>'; ?>
		<?php echo $form->passwordField($model,'newpasswd',array('size'=>60,'maxlength'=>255, 'value'=>'')); ?>
		<?php echo $form->error($model,'newpasswd'); ?>
	</div>

	<div class="row">
		<?php echo '<label for="newpasswd_repeat" class="required">Re-enter new password<span class="required">*</span></label>'; ?>
