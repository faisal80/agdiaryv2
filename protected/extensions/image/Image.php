...
class Image {
	 ...
	 *
	 * @param   integer  $in to inputgamma, 0.01 to 5
	 * @param   integer  $out to outputgamma, 0.01 to 5
	 * @return  object
	 */
	public function gamma_correction($in, $out)
	{
		$this->actions['gamma_correction'] = array ('in'=>$in, 'out'=>$out);
